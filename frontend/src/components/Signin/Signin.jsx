        ...
        <div className="container mx-auto px-4 py-6">
          <nav className="flex justify-between items-center">
            ...
            <div>
              ...
              >
                Sign Up <FaArrowRight className="ml-1" />
              </Link>
            </div>
          </nav>
        </div>
                ...
                <div>
                  ...
                  <div className="flex justify-between mt-2">
                    <div className="flex items-center">
                      ...
                      <label
                        htmlFor="remember-me"
                        className="ml-2 text-sm text-indigo-100"
                      >
                        Remember me
                      </label>
                    </div>
                    <Link
                      to="/forgot-password"
                      className="text-sm text-indigo-200 hover:text-white hover:underline transition-colors duration-200"
                    >
                      Forgot password?
                    </Link>
                  </div>
